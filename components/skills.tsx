          ...
          {Object.entries(skills).map(([category, skillList]) => (
            <div key={category} className="animate-slide-up">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4 flex-1 h-px bg-gradient-to-r from-gray-300 to-transparent dark:from-gray-600"></div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                {skillList.map((skill, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="glass dark:glass-dark p-4 rounded-xl hover-lift group cursor-pointer"
                    >
                      <div className="flex flex-col items-center text-center space-y-3">
                        <div className={`p-3 bg-gradient-to-br ${categoryColors[category as keyof typeof categoryColors]} rounded-lg group-hover:scale-110 transition-transform`}>
